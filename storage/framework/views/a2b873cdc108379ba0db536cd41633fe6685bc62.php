    ...
    <section class="section">
        <div class="d-flex flex-wrap align-items-stretch">
            ...
            <div class="text-light p-5 pb-2">
              <div class="mb-2 pb-3">
                <h1 class="mb-2 display-4 font-weight-bold">Ghostrrr LMS</h1>
                <h5 class="font-weight-normal text-muted-transparent">fully-featured educational platform</h5>
              </div>
              All rights reserved for <a class="text-light bb" target="_blank" href="https://tanicsys.com">Ghostrrr</a> By <a class="text-light bb" target="_blank" href="https://wa.me/918320262250">Anuragsingk</a>
            </div>
          </div>
            </div>
...
<?php /**PATH C:\xampp\htdocs\platform\resources\views/admin/auth/auth_layout.blade.php ENDPATH**/ ?>